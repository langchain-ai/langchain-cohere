...
@deprecated(
    ...
    removal="1.0.0",
    message=(
        "Use langgraph's create_react_agent with ChatCohere instead. "
        "ChatCohere supports native tool calling via the Cohere V2 API, "
        "making this custom multi-hop agent unnecessary. "
...
class _AddCitations(Runnable):
    ...
    last step is an `AgentFinish`.

    Citations are generated from the observations (made in previous agent steps) and the
    grounded answer (made in the last step).
    """
